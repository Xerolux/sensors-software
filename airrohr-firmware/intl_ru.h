...
const char INTL_MORE_SENSORS[] PROGMEM = "Иные датчики";
...
const char INTL_HEIGHT_ABOVE_SEALEVEL[] PROGMEM = "Высота над уровнем моря (м)";
...
const char INTL_USE_BETA[] PROGMEM = "Устанавливать бета-версии";
...
#define INTL_STATIC_IP_TEXT "Настроить статический IP (необходимо заполнить все поля!)"
const char INTL_STATIC_IP[] PROGMEM = "IP адрес";
const char INTL_STATIC_SUBNET[] PROGMEM = "Подсеть";
const char INTL_STATIC_GATEWAY[] PROGMEM = "Шлюз";
const char INTL_STATIC_DNS[] PROGMEM = "DNS сервер";
...
const char INTL_DELETE_CONFIG[] PROGMEM = "Удалить config.json ";
