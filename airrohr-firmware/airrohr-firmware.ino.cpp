# 1 "C:\\Users\\basti\\AppData\\Local\\Temp\\tmpn0b5shqz"
#include <Arduino.h>
# 1 "C:/Users/basti/Documents/GitHub/sensors-software/airrohr-firmware/airrohr-firmware.ino"
# 57 "C:/Users/basti/Documents/GitHub/sensors-software/airrohr-firmware/airrohr-firmware.ino"
#include <WString.h>
#include <pgmspace.h>
...
# 131 "C:/Users/basti/Documents/GitHub/sensors-software/airrohr-firmware/airrohr-firmware.ino"
namespace cfg
{
...
float last_value_IPS_P0 = -1.0;
float last_value_IPS_P1 = -1.0;
float last_value_IPS_P2 = -1.0;
float last_value_IPS_P01 = -1.0;
float last_value_IPS_P03 = -1.0;
float last_value_IPS_P05 = -1.0;
float last_value_IPS_P5 = -1.0;
float last_value_IPS_N1 = -1.0;
float last_value_IPS_N10 = -1.0;
float last_value_IPS_N25 = -1.0;
float last_value_IPS_N01 = -1.0;
float last_value_IPS_N03 = -1.0;
...
void setup(void);
void loop(void);
#line 684 "C:/Users/basti/Documents/GitHub/sensors-software/airrohr-firmware/airrohr-firmware.ino"
static void display_debug(const String &text1, const String &text2)
{
...
static void wifiConfig()
{
 ...
 int8_t scanReturnCode = WiFi.scanNetworks(false , true );
 if (scanReturnCode < 0)
 {
...
# 3126 "C:/Users/basti/Documents/GitHub/sensors-software/airrohr-firmware/airrohr-firmware.ino"
static void create_influxdb_string_from_data(String &data_4_influxdb, const String &data)
{
 JsonDocument json2data;
...
static void fetchSensorIPS(String &s)
{
 ...
 if (send_now)
 {
  ...
  last_value_IPS_P0 = -1.0;
  last_value_IPS_P1 = -1.0;
  last_value_IPS_P2 = -1.0;
  last_value_IPS_P01 = -1.0;
  last_value_IPS_P03 = -1.0;
  last_value_IPS_P05 = -1.0;
  last_value_IPS_P5 = -1.0;
...
# 5739 "C:/Users/basti/Documents/GitHub/sensors-software/airrohr-firmware/airrohr-firmware.ino"
   }
 ...
 if (cfg::ips_read)
 {
  IPS_cmd(PmSensorCmd3::Factory);
  delay(1000);
  IPS_version_date();
  delay(1000);
  IPS_cmd(PmSensorCmd3::Smoke);
  delay(1000);
  IPS_cmd(PmSensorCmd3::Interval);
  delay(1000);
  IPS_cmd(PmSensorCmd3::Stop);
  delay(1000);
  is_IPS_running = false;
...
#if defined(ESP8266)
 if ((airrohr_selftest_failed = !ESP.checkFlashConfig() ))
 {
